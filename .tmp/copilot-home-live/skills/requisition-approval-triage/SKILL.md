---
name: requisition-approval-triage
description: >-
  Find Coupa requisitions stuck in approval, cross-reference the requester's ServiceNow tickets, then ask the
  manager to approve, reject, or hold. Use when approvals are piling up in Coupa.
license: Proprietary demo content
metadata:
  title: Requisition Approval Triage
  version: "1.1"
  domain: supply-chain
  servers: coupa servicenow
  launch: Triage the Coupa requisitions stuck in approval.
---
