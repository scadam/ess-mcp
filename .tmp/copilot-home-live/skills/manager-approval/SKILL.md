...
description: >-
  Triage the top P1 incident, then ask the manager for a yes/no escalation decision via Teams. Use when a
  high-impact incident may need escalation that a manager must decide.
...
metadata:
  ...
  launch: Triage the top P1 incident and get my manager's escalation decision.
---
