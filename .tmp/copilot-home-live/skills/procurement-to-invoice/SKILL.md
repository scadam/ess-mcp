---
name: procurement-to-invoice
description: >-
  Reconcile recent Coupa invoices and POs against ServiceNow receiving and IT tickets to surface
  pay-but-not-received discrepancies. Use for a quick invoice-versus-receipt check on recent orders.
license: Proprietary demo content
metadata:
  title: Procurement To Invoice
  version: "1.1"
  domain: supply-chain
  servers: coupa servicenow
  launch: Reconcile recent Coupa invoices against receipts and ServiceNow tickets.
---
