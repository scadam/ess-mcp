...
description: >-
  Triage active ServiceNow incidents with Workday availability context. Use when asked to triage, prioritise or
  route open incidents, or to check who is available to work them.
...
metadata:
  ...
  launch: Triage the active ServiceNow incidents for my team.
---
